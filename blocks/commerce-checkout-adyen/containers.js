 ...
 * @param {Object} billingFormRef - React-style ref for billing form
...
export const renderBillToShippingAddress = async (container, placeOrderButton = null) => renderContainer(
  ...
  async () => {
    // Create billing address setter with optional place order button
    const setBillingAddressOnCart = createAddressSetter('billing', placeOrderButton);
...
/**
 * Creates an address setter function for shipping or billing addresses
 * @param {string} addressType - Type of address ('shipping' or 'billing')
 * @param {Object} placeOrderButton - Place order button reference for state management
 * @returns {Function} - Configured address setter function
 */
const createAddressSetter = (addressType, placeOrderButton) => {
  const api = addressType === 'shipping'
    ? checkoutApi.setShippingAddress
    : checkoutApi.setBillingAddress;

  return setAddressOnCart({
    api,
...
export const renderCustomerShippingAddresses = async (container, formRef, data, placeOrderButton) => renderContainer(
  ...
  async () => {
    ...
    // Create shipping address setter
    const setShippingAddressOnCart = createAddressSetter('shipping', placeOrderButton);
...
export const renderAddressForm = async (container, formRef, data, placeOrderButton, addressType) => {
  ...
  return renderContainer(
    ...
    async () => {
      ...
      const setAddressOnCartFn = createAddressSetter(addressType, placeOrderButton);
