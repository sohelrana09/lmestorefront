...
`;async function N(){return await o(C,{method:"GET",cache:"no-cache"}).then(t=>{var a;if((a=t.errors)!=null&&a.length)return m(t.errors);const n=t.data.company.structure;return y(n)}).catch(u)}const _=`
...
`;async function S(t){const n={treeId:t.id,parentTreeId:t.parentId};return await o(_,{variables:n}).then(a=>{var e,r;return(e=a.errors)!=null&&e.length?m(a.errors):!!((r=a==null?void 0:a.data)!=null&&r.updateCompanyStructure)}).catch(u)}const f=`
...
`;async function M(t){const n={name:t.name,description:t.description,target_id:t.targetId};return await o(f,{variables:{input:n}}).then(a=>{var r,i,d;if((r=a.errors)!=null&&r.length)return m(a.errors);const e=(d=(i=a==null?void 0:a.data)==null?void 0:i.createCompanyTeam)==null?void 0:d.team;return e?{id:e.id,structureId:e.structure_id,name:e.name}:null}).catch(u)}const h=`
  mutation updateCompanyTeam($input: CompanyTeamUpdateInput!) {
    updateCompanyTeam(input: $input) { __typename team { id name } }
  }
`;async function R(t){const n={id:t.id,name:t.name,description:t.description};return await o(h,{variables:{input:n}}).then(a=>{var e,r,i,d;return(e=a.errors)!=null&&e.length?m(a.errors):!!((d=(i=(r=a==null?void 0:a.data)==null?void 0:r.updateCompanyTeam)==null?void 0:i.team)!=null&&d.id)}).catch(u)}const T=`
...
`;async function G(t){return await o(g,{variables:{id:t}}).then(n=>{var e,r,i;if((e=n.errors)!=null&&e.length)return m(n.errors);const a=(i=(r=n==null?void 0:n.data)==null?void 0:r.company)==null?void 0:i.user;return a?l(a):null}).catch(u)}const b=`
...
`;async function q(){return await o(b,{method:"GET"}).then(t=>{var a,e,r,i;if((a=t.errors)!=null&&a.length)return m(t.errors);const n=((i=(r=(e=t==null?void 0:t.data)==null?void 0:e.company)==null?void 0:r.roles)==null?void 0:i.items)??[];return s(n)}).catch(u)}const $=`
  query isCompanyUserEmailAvailable($email: String!) {
    isCompanyUserEmailAvailable(email: $email) { is_email_available }
  }
`;async function L(t){return await o($,{variables:{email:t}}).then(n=>{var a,e,r;return(a=n.errors)!=null&&a.length?m(n.errors):((r=(e=n==null?void 0:n.data)==null?void 0:e.isCompanyUserEmailAvailable)==null?void 0:r.is_email_available)??null}).catch(u)}export{q as a,j as b,P as c,M as d,R as e,N as f,G as g,S as h,L as i,Y as j,D as k,O as u};
