...
`,N=async()=>{var e,r,n;try{const a=await m(f,{method:"GET",cache:"no-cache"});return(e=a.errors)!=null&&e.length?{creditEnabled:!1,error:"Unable to check company credit configuration"}:((n=(r=a.data)==null?void 0:r.storeConfig)==null?void 0:n.company_credit_enabled)===!0?{creditEnabled:!0}:{creditEnabled:!1,error:"Company credit is not enabled in store configuration"}}catch{return{creditEnabled:!1,error:"Company credit functionality not available"}}};export{u as CompanyCreditOperationType,q as DEFAULT_COUNTRY,K as STORE_CONFIG_DEFAULTS,w as allowCompanyRegistration,U as buildPermissionTree,N as checkCompanyCreditEnabled,B as companyEnabled,W as createCompany,Re as createCompanyRole,J as createCompanyTeam,ae as createCompanyUser,Te as deleteCompanyRole,V as deleteCompanyTeam,ie as deleteCompanyUser,m as fetchGraphQl,D as fetchUserPermissions,_ as flattenPermissionIds,pe as getCompany,Ae as getCompanyAclResources,Ee as getCompanyCredit,ge as getCompanyCreditHistory,A as getCompanyRole,_e as getCompanyRoles,X as getCompanyStructure,Z as getCompanyTeam,te as getCompanyUser,ce as getCompanyUsers,I as getConfig,ue as getCountries,Q as getCustomerCompany,z as getStoreConfig,S as initialize,b as isCompanyAdmin,Ue as isCompanyRoleNameAvailable,F as isCompanyUser,oe as isCompanyUserEmailAvailable,P as removeFetchGraphQlHeader,G as setEndpoint,L as setFetchGraphQlHeader,M as setFetchGraphQlHeaders,de as updateCompany,Se as updateCompanyRole,$ as updateCompanyStructure,ee as updateCompanyTeam,ne as updateCompanyUser,se as updateCompanyUserStatus,fe as validateCompanyEmail};
